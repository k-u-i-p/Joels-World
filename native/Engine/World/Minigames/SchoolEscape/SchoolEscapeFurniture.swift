...
enum SchoolEscapeFurniture {
    ...
    static let boxes: [(x: Double, y: Double, w: Float, l: Float, h: Float, hex: String)] = [
        (-2455, -1300, 200, 90, 150, "#5d3f24"),
        (-1800, -1300, 200, 90, 150, "#5d3f24"),
        (2600, -725, 200, 650, 110, "#8f979c"),
        (-250, -700, 64, 72, 55, "#d8d8d8"),
        (75, -700, 64, 72, 55, "#d8d8d8"),
        (1930, -665, 120, 550, 110, "#8f979c"),
        (2262, -660, 208, 320, 110, "#8f979c"),
        (-95, -655, 64, 48, 75, "#d8d8d8"),
        (215, -655, 64, 48, 75, "#d8d8d8"),
        (-1540, -520, 64, 288, 90, "#6b4a2a"),
        (-1526, -106, 96, 256, 55, "#71512f"),
        (-780, -40, 380, 80, 85, "#6b4a2a"),
        (-940, 30, 80, 160, 85, "#6b4a2a"),
        (-350, 594, 32, 64, 90, "#6b4a2a"),
        (1966, 656, 64, 80, 90, "#6b4a2a"),
        (-2236, 1242, 112, 80, 90, "#6b4a2a"),
        (-2068, 1242, 112, 80, 90, "#6b4a2a"),
        (-2410, 1246, 112, 80, 90, "#6b4a2a"),
        (-2068, 1302, 64, 48, 90, "#6b4a2a"),
        (-2410, 1304, 64, 48, 90, "#6b4a2a"),
        (-2236, 1304, 64, 48, 90, "#6b4a2a"),
    ]
