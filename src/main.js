  ...
  for (const action of actions) {
    for (const [key, payload] of Object.entries(action)) {
      if (EventHandlers[key]) {
        EventHandlers[key](sourceObj, payload);
      }
    }
  }
}
